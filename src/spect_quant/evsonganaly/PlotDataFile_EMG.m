function PlotDataFile_EMG(hObject,handles);
...
EMGchanspec=handles.EMGChanSpec;
[dat,Fs,DOFILT,ext]=ReadDataFile(FNAME,chanspec);
[EMG_dat,EMG_Fs,EMG_DOFILT,EMG_ext]=ReadDataFile(FNAME,EMGchanspec);

% spec calculated

[sm,sp,t,f,filtsong]=SmoothData_EMG(dat,Fs,DOFILT);
[smEMG,spEMG,tEMG,fEMG,filtEMG]=SmoothData_EMG(EMG_dat,EMG_Fs,EMG_DOFILT,0,512,0.8,2.0,200,5000);
...
handles.NEWAXIS
axes(handles.NEWAXIS);hold off;
plot([1:length(filtEMG(1:dsamp:end))]*dsamp/EMG_Fs,filtEMG(1:dsamp:end),'b-'); hold on;
